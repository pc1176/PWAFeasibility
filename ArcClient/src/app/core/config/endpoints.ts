export const API_ENDPOINTS = {
  BASE_URL: 'https://nor-parameter-madrid-satin.trycloudflare.com',
  AUTH: {
  ...
  // HLS_BASE_URL : 'mediamtx.service.custom.local:8888',
  // MEDIAMTX_URL : 'mediamtx.service.custom.local',
  // PLAYBACK_URL : 'http://matrix.service.custom.local:4200/assets/hls/recording1/output.m3u8'
  PN_URL : '',
